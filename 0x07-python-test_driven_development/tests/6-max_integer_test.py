...
class TestMaxInteger(unittest.TestCase):
    """Class for testing max integer function using unittest"""

    def test_normal_values(self):
        """ unit test to test normal values"""
        self.assertEqual(max_integer([1, 2, 4, 3]), 4)

    def test_normal_values_pos_neg(self):
        """ unit test to test normal values pos and neg"""
        self.assertEqual(max_integer([-1, 2, 4, 3, -9, 17]), 17)

    def test_normal_beg(self):
        """untit test to test max at beginning"""
        self.assertEqual(max_integer([4, 1, 2, 3]), 4)

    def test_normal_end(self):
        """untit test to test max at end"""
        self.assertEqual(max_integer([4, 1, 2, 3, 10]), 10)

    def test_no_arg(self):
        """unit test to test no arg"""
        self.assertEqual(max_integer(), None)

    def test_empty_list(self):
        """unit test to test empty list"""
        self.assertEqual(max_integer([]), None)

    def test_neg_int(self):
        """unit test to test negative ints"""
        self.assertEqual(max_integer([-32, -2, -10, -1, -15, -100]), -1)

    def test_neg_float(self):
        """unit test to test negative floats"""
        self.assertEqual(max_integer([-0.234, -0.2, -0.19, -0.12, -0.5678, -0.96712]), -0.12)

    def test_float(self):
        """unit test to test floats"""
        self.assertEqual(max_integer([0.234, 0.2, 0.19, 0.12, 0.5678, 0.96712]), 0.96712)

    def test_str(self):
        """unit test to test string input"""
        self.assertEqual(max_integer("Holberton"), "t")

    def test_num_str(self):
        """unit test to test num string input"""
        self.assertEqual(max_integer("3456789876543234567888"), "9")

    def test_lists(self):
        """unit test to test lists input"""
        self.assertEqual(max_integer([[0], [], [10], [3, 11]]), [10])

    def test_list_string(self):
        """Unit test for test string list"""
        self.assertEqual(
            max_integer([["foo"], ["boo"], ["abc"], ["sic"], ["ric"]]),
            ["sic"])

    def test_pos_neg_large(self):
        """Unit test for test pos-neg large ints"""
        self.assertEqual(
            max_integer(
    ...
    def test_neg_large(self):
        """Unit test for test large neg ints"""
        self.assertEqual(
            max_integer(
    ...
    def test_int_float_large(self):
        """Unit test for test large float and ints"""
        self.assertEqual(
            max_integer(
    ...
    def test_float_large(self):
        """Unit test for test large float numbers"""
        self.assertEqual(
            max_integer(
    ...
    def test_infinity(self):
        """Unit test for test infinity"""
        self.assertEqual(max_integer([103, float('inf'), float('-inf')]),
                         float('inf'))

    def test_nan(self):
        """Unit test for testing nan"""
        self.assertEqual(max_integer([301, float('nan'), 100]), 301)

    def test_mix_list(self):
        """Unit test for testing mixed list"""
        self.assertRaises(TypeError, max_integer, [[], [212], [5], [2, 9], 99, "Holberton"])

    def test_ip_none(self):
        """Unit test for testing none input"""
        self.assertRaises(TypeError, max_integer, None)

    def test_ip_dict(self):
        """Unit test for dictionary"""
        self.assertRaises(TypeError, max_integer, [{"a": 23, "b": 45}, {12: 25}])

    def test_ip_int(self):
        """Unit test for test 1 input int"""
        self.assertRaises(TypeError, max_integer, 1)

    def test_ip_float(self):
        """Unit test for test 1 ip float"""
